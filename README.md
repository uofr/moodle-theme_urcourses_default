moodle-theme_uofr_conservatory
=========================

[![Build Status](https://travis-ci.org/moodleuulm/moodle-theme_uofr_conservatory.svg?branch=master)](https://travis-ci.org/moodleuulm/moodle-theme_uofr_conservatory)
...
This setting is already available in the Moodle core theme Boost. For more information how to use it, please have a look at the official Moodle documentation: http://docs.moodle.org/en/Boost_theme
Please note: This will not override the setting "theme_uofr_conservatory | loginbackgroundimage" which means that the pictures uploaded to the login page background will be displayed anyway.
...
@font-face {
        ...
        font-weight: 400;
        /* IE9 Compat Modes */
        src: url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-regular.eot");
        src: local("Your Font"), local("YourFont-Regular"),
               /* IE6-IE8 */
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-regular.eot?#iefix") format("embedded-opentype"),
                /* Super Modern Browsers */
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-regular.woff2") format("woff2"),
                /* Modern Browsers */
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-regular.woff") format("woff"),
                /* Safari, Android, iOS */
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-regular.ttf") format("truetype"),
                /* Legacy iOS */
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-regular.svg#YourFont") format("svg");
\}
...
@font-face {
        ...
        font-style: italic;
        font-weight: 400;
        src: url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-italic.eot");
        src: local("Your Font Italic"), local("YourFont-Italic"),
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-italic.eot?#iefix") format("embedded-opentype"),
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-italic.woff2") format("woff2"),
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-italic.woff") format("woff"),
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-italic.ttf") format("truetype"),
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-italic.svg#YourFont") format("svg");
}
/* your-font-700 - latin */
@font-face {
        font-family: "Your Font";
        font-style: normal;
        font-weight: 700;
        src: url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-700.eot");
        src: local("Your Font Bold"), local("YourFont-Bold"),
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-700.eot?#iefix") format("embedded-opentype"),
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-700.woff2") format("woff2"),
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-700.woff") format("woff"),
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-700.ttf") format("truetype"),
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-700.svg#YourFont") format("svg");
}
...
@font-face {
        ...
        font-style: italic;
        font-weight: 700;
        src: url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-700italic.eot");
        src: local("Your Font Bold Italic"), local("YourFont-BoldItalic"),
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-700-italic.eot?#iefix") format("embedded-opentype"),
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-700-italic.woff2") format("woff2"),
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-700-italic.woff") format("woff"),
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-700-italic.ttf") format("truetype"),
                url("/pluginfile.php/1/theme_uofr_conservatory/fontfiles/0/your-font-latin-700-italic.svg#YourFont") format("svg");
}
...
http://moodle.org/plugins/view/theme_uofr_conservatory

The latest development version can be found on Github:
https://github.com/moodleuulm/moodle-theme_uofr_conservatory
...
https://github.com/moodleuulm/moodle-theme_uofr_conservatory/issues
...
https://github.com/moodleuulm/moodle-theme_uofr_conservatory/pulls
