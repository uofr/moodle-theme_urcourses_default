...
$string['showbody'] = 'Are you sure you want to show this course? The course will be visible to students enroled in the {$a} semester.';
$string['showbody_noenrollment'] = 'Are you sure you want to show this course? If students are enroled, the course will be visible to them.';
$string['hidetitle'] = 'Hide Course?';
$string['hidebody'] = 'Are you sure you want to hide this course? This course will be hidden from students enroled in the {$a} semester.';
$string['hidebody_noenrollment'] = 'Are you sure you want to hide this course? If students are enroled, the course will be hidden from them.';
