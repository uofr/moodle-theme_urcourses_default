...
$string['fall'] = 'Fall';
$string['hasenrolment'] = 'This course page has Banner enrolment from {$a}.';
$string['hasenrolment_help'] = 'If you would like to reuse this course page, {$a} and add enrolment to the course copy.';
