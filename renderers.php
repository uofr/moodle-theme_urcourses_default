 ...
 */
class theme_urcourses_default_core_h5p_renderer extends theme_boost_union_core_h5p_renderer {
    ...
    public function h5p_alter_styles(&$styles, $libraries, $embedtype) {
        ...
        $h5pcssurl = new core\url('/theme/urcourses_default/h5p/styles.php');
...
if (file_exists($CFG->dirroot.'/mod/hvp/renderer.php')) {
    ...
    if (class_exists('theme_boost_union_mod_hvp_renderer')) {
        class theme_urcourses_default_mod_hvp_renderer extends theme_boost_union_mod_hvp_renderer {
            /**
