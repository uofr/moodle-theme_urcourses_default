...
// load additional css
$PAGE->requires->css('/theme/urcourses_default/style/legacy.css?v=2023051501');
...
$PAGE->requires->css('/theme/urcourses_default/style/callout.css?v=2023051501');
$PAGE->requires->css('/theme/urcourses_default/style/alert.css?v=2023051501');
//$PAGE->requires->css('/theme/urcourses_default/style/button.css');
$PAGE->requires->css('/theme/urcourses_default/style/pullquote.css?v=2023051501');
...
if($darkmodecheck){
   $PAGE->requires->css('/theme/urcourses_default/style/darkmode.css?v=2023051501');
}
