...
// load additional css
$PAGE->requires->css('/theme/urcourses_default/style/legacy.css?v=2023060801');
...
$PAGE->requires->css('/theme/urcourses_default/style/callout.css?v=2023060801');
$PAGE->requires->css('/theme/urcourses_default/style/alert.css?v=2023060801');
//$PAGE->requires->css('/theme/urcourses_default/style/button.css');
$PAGE->requires->css('/theme/urcourses_default/style/pullquote.css?v=2023060801');
$PAGE->requires->css('/theme/urcourses_default/style/c4l.css?v=2023060801');
...
if($darkmodecheck){
   $PAGE->requires->css('/theme/urcourses_default/style/darkmode.css?v=2023060801');
}
