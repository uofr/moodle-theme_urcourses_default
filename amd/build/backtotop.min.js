 ...
 */
define("theme_urcourses_default/backtotop",["jquery","core/str","core/notification"],(function($,str,Notification){return{init:function(){var stringsPromise;stringsPromise=str.get_string("backtotop","theme_urcourses_default"),$.when(stringsPromise).then((function(string){return $("#page-footer").after('<i class="fa fa-chevron-up fa-2x d-print-none"id="back-to-top" aria-label="'+string+'"></i>'),$(window).scroll((function(){$(document).scrollTop()>220?$("#back-to-top").fadeIn(300):$("#back-to-top").fadeOut(100)})),$("#back-to-top").click((function(event){event.preventDefault(),$("html, body").animate({scrollTop:0},500)})),!0})).fail(Notification.exception)}}}));
