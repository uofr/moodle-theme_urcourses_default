define ("theme_urcourses_default/backtotop",["jquery","core/str"],function(a,b){"use strict";function c(){var c=b.get_string("backtotop","theme_urcourses_default");a.when(c).then(function(b){a("#page-footer").after("<i class=\"fa fa-chevron-up fa-2x d-print-none\"id=\"back-to-top\" aria-label=\""+b+"\"></i>");a(window).scroll(function(){if(220<a(document).scrollTop()){a("#back-to-top").fadeIn(300)}else{a("#back-to-top").fadeOut(100)}});a("#back-to-top").click(function(b){b.preventDefault();a("html, body").animate({scrollTop:0},500)});return!0}).fail(Notification.exception)}return{init:function init(){c()}}});
