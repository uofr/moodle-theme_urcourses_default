...
define(['jquery', 'core/ajax', 'core/notification', 'core/str',
    ...
    var _registerEventListeners = function() {
        _root.on('click', SELECTORS.BTN_COURSEENROL, _courseenrolAction);
    ...
    var _courseenrolAction = function() {
        ...
        */
        ...
        ModalFactory.create({
            ...
            title: modaltitle,
            body: "<p><b>Are you sure you want to activate enrolment for this course?</b><br />"
			      + "<small>The following CRNs have been selected:</small>"
                  + "</p>"
        })
        .then(function(modal) {
