...
define(['jquery', 'core/ajax', 'core/notification', 'core/str',
    ...
    var _registerModalButtons = function() {
        //set event listners for template options
        $('#btn_duplicatemodal').bind('click', function() { _callCourseRequest($(this)) } );   
        $('#btn_newmodal').bind('click', function() { _callCourseRequest($(this)) } );   
    }
     ...
     * Switch choosen template based on click in template list
     */
    var _callCourseRequest = function(e) {

        id = $(e).attr('id');

        if(id=="btn_duplicatemodal"){
            _coursereqAction(e);
        }else{
            _coursereqAction(e);
        }
