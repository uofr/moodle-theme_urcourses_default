...
export const getEnrolledCoursesByTimeline = args => {
    const request = {
        methodname: 'theme_urcourses_default_get_enrolled_courses_by_timeline_classification',
        args: args
    };
...
export const getCourseSummary = args => {
    const request = {
        methodname: 'theme_urcourses_default_get_course_summary',
        args: args
    };
