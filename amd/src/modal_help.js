...
import ModalHelpAjax from 'theme_uofr_conservatory/modal_help_ajax';
import FuzzySearch from 'theme_uofr_conservatory/fuzzysearch';
...
const TEMPLATES = {
    MODAL_HELP_GUIDE_PAGE: 'theme_uofr_conservatory/modal_help_guide_page',
    MODAL_HELP_SEARCH_RESULTS: 'theme_uofr_conservatory/modal_help_search_results',
    MODAL_HELP_LINKS_PAGE: 'theme_uofr_conservatory/modal_help_links',
...
export default class ModalHelp extends Modal {
     ...
     */
    static getType() {
        return 'theme_uofr_conservatory-help';
    }
}
...
if (!registered) {
    ModalRegistry.register(ModalHelp.getType(), ModalHelp, 'theme_uofr_conservatory/modal_help');
    registered = true;
}
