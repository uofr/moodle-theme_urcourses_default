...
/**
 * Test student unenrol external function.
 *
...
class unenrol_test_student extends external_api {
    ...
    public static function execute($courseid) {
        ...
        if (!is_enrolled($context, $user->id)) {
            throw new \moodle_exception('teststudentnotenrolled', 'theme_urcourses_default');
        }
        ...
        if (is_enrolled($context, $user->id)) {
            throw new \moodle_exception('teststudentcouldnotunenrol', 'theme_urcourses_default');
        }
