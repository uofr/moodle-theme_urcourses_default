...
namespace theme_urcourses_default;
...
class boostnavbar implements \renderable {
    ...
    protected function prepare_nodes_for_boost(): void {
		...
		// try to add course home icon
		
        $coursehomenode = navigation_node::create($this->page->course->shortname,
                new moodle_url('/course/view.php', array('id' => $this->page->course->id)),
                navigation_node::TYPE_SETTING,
                null,
                'competencies2',
                new pix_icon('i/competencies', ''));
        // Add the competencies node.
        //$this->add($coursehomenode);
