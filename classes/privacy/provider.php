 ...
 *
 * @package    theme_urcourses_default
 * @copyright  2020 Kathrin Osswald, Ulm University <alexander.bias@uni-ulm.de>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider implements \core_privacy\local\metadata\provider,
    ...
    public static function get_metadata(collection $collection) : collection {
        $collection->add_user_preference('theme_urcourses_default_infobanner_dismissed',
    ...
    public static function export_user_preferences(int $userid) {
        $infobannerpref = get_user_preferences('theme_urcourses_default_infobanner_dismissed', null, $userid);
        if ($infobannerpref !== null) {
            ...
            writer::export_user_preference('theme_urcourses_default', 'theme_urcourses_default_infobanner_dismissed',
